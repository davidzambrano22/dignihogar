        ...
        column(8, offset = 2,
          wellPanel(
            fluidRow(style = "background: white;",
              ...
              # ),
              tags$p(
                "Parágrafo 1. El TRABAJADOR De igual forma, deberá hacer los aportes de seguridad social en salud, pensión y ARL, en proporción a los días trabajados y conforme al salario recibido.",
                style = "font-size: 21px; text-align: justify;"
              ),
              tags$p(
