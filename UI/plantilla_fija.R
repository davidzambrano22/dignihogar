...
plantillaFijaUI <- function(input, output){
         ...
         wellPanel(
            ...
            div(style = "height: 30px"),
             ...
             column(8,
                    ...
                    tags$p(tags$b("Salario acordado sin beneficios ni deducciones:", style = "font-size: 21px; text-align: justify;"), "$", input$salario_mensual, style = "font-size: 21px; text-align: justify;", style = "text-align: justify;"),
                    conditional_paragraph <- if (as.numeric(input$salario_mensual) < 2600000 || input$tipo_vinculacion == "Por días (es decir, la persona trabajadora doméstica que labora en diferentes hogares a la semana y recibe pagos por el día laborado)") {
                      ...
                      tags$p(tags$b("Subsidio de transporte: "), as.character(subsidio_transporte), style = "font-size: 21px; text-align: justify;", style = "text-align: justify;")
                    } else {
                    ...
                    tags$ul(
                      tags$li("Vacaciones pagadas por el empleador: 15 días al año (o proporcional)", style = "text-align: justify;"),
                      tags$li(
                        tags$p(sprintf("Prima: Un salario al año (o proporcional) Medio salario el 30 junio ($ %d)", as.numeric(input$salario_mensual) / 2), sprintf("Prima: Un salario al año (o proporcional) Medio salario el 30 junio ($ %d)", as.numeric(input$salario_mensual) / 2), style = "text-align: justify;")
                      ),
                      tags$li(
                        tags$p(sprintf("Cesantías: Consignadas al fondo del empleado. Un salario a año ($ %d)", as.numeric(input$salario_mensual)), sprintf(" y 12%% de intereses anual ($ %d)", as.numeric(input$salario_mensual) * 0.12), style = "text-align: justify;")
                      ),
