    ...
    tagList(
      ...
      column(8, offset = 2,
             wellPanel(
               ...
               tags$p("Parágrafo 1. El EMPLEADOR deberá pagar al TRABAJADOR todas las prestaciones sociales establecidas por ley: cesantías, prima, vacaciones y auxilio de transporte, de ser el caso. El pago de dichas prestaciones se hará en proporción a los días trabajados y conforme al salario recibido.",
                      style = "font-size: 21px; text-align: justify;"
                      ),
               tags$p(
                 "Parágrafo 2. De igual forma, deberá hacer los aportes de pensión, en proporción a los días trabajados y conforme al salario recibido. El pago de riesgos profesionales y aportes a caja de compensación será por el mes completo.  Esto sin perjuicio que el trabajador esté afiliado al Sisbén.",
                 style = "font-size: 21px; text-align: justify;"
               ),
               tags$p(
